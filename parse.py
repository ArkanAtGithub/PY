...
# File path
file_path = '/home/arkan/Downloads/data-20240811-1359.circuitjs.txt'
...
try:
    ...
    print(f"No file found! Path: '{file_path}'")
    exit()
...
peak_threshold_value = 0.10 * np.max(fft_data)  # Set the peak threshold to be 1/4 the value
...
time_taken = b - a
print("================")
print(f"Time taken to generate figure {time_taken:.6f} second")
